...
argv = opti.usage('Downsize retina images.\nUsage: $0')
	...
	.alias('v', 'verbose')
    .describe('v', 'Verbosity level. 0: Silent, 1: Log start and end, 2: (Default) Log each operation.')

    .boolean('r')
    .alias('r', 'recursive')
    .describe('r', 'Use to fetch and downsize all assets in a directory tree')
